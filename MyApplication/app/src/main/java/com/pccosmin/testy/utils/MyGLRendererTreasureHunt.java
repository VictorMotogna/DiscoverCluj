...
import com.pccosmin.testy.model.TextureCubeTreasureHunt;


public class MyGLRendererTreasureHunt implements GLSurfaceView.Renderer {

    private Context context;   // Application context needed to read image (NEW)
    private TextureCubeTreasureHunt cube;
    ...
    // Constructor
    public MyGLRendererTreasureHunt(Context context) {
        this.context = context;   // Get the application context (NEW)
        cube = new TextureCubeTreasureHunt();
    }
